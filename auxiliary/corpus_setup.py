...
def select_corpus(number):
    ...
    if number == 0:
        ...
        pathLoad = r'C:\Users\mauro\OneDrive\Dokumente\Python_Scripts\LawProject\openlegaldata'
        language = 'de'
        delimiter = ','
        column_name = 'content'
        ...
        pathLoad = r'C:\Users\mauro\OneDrive\Dokumente\Python_Scripts\LawProject\reuters'
        language = 'de'
        delimiter = ';'
        column_name = 'text'
