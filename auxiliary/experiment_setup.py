...
def select_experiment(experiment_name):
    ...
    if experiment_name == 'final_roland':
        ...
        num_corpus = 1
        single = False
        word_list_csv = 'relevant_words_v7_bigram.csv' #'relevant_words_v6_20k_per_corpus.csv'
        
        
        rename_models(os.path.join(pathMain, 'de_StR_r', 'Models'), 'de', 'de5')
        rename_models(os.path.join(pathMain, 'de_Zivil_r', 'Models'), 'de', 'de6')
        rename_models(os.path.join(pathMain, 'en_supreme_court_r', 'Models'), 'en', 'en5')
        ...
        rename_models(os.path.join(pathMain, 'de_Zivil_shuffled', 'Models'), 'de', 'de16')
        rename_models(os.path.join(pathMain, 'en_supreme_court_shuffled', 'Models'), 'en', 'en15')
        ...
        rename_models(os.path.join(pathMain, 'en_sc_sentence_level_skip', 'Models'), 'en', 'en4')
        ...
        pathFolders = [(os.path.join(pathMain, 'en_sc_sentence_level_skip'), ['en4']),
